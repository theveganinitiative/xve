...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("theveganinitiative-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("theveganinitiative-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("theveganinitiative-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "theveganinitiative " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("theveganinitiative-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("theveganinitiative-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("theveganinitiative-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("theveganinitiative-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. theveganinitiative is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("theveganinitiative-start");
