...
const string strMessageMagic = "theveganinitiative Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // XVE ICO SUPPLY
    {
        nSubsidy = 5000000 * COIN;
    }
    else if(pindexBest->nHeight < 900000) // 0 Blocks
    {
        nSubsidy = 0 * COIN;
    }
...
// theveganinitiative: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "theveganinitiative", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "XVE The Vegan Inititative";
        CTransaction txNew;
        txNew.nTime = 1488831893;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xec58bf8272fef2c18ad21b5791da62ac1bbdad2d4322cd29f9ad9bd39f01ba27"));
        block.print();
